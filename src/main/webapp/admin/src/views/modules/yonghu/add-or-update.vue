               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="保管人员姓名" prop="yonghuName">
                       <el-input v-model="ruleForm.yonghuName"
                                 placeholder="保管人员姓名" clearable  :readonly="ro.yonghuName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="保管人员手机号" prop="yonghuPhone">
                       <el-input v-model="ruleForm.yonghuPhone"
                                 placeholder="保管人员手机号" clearable  :readonly="ro.yonghuPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="保管人员身份证号" prop="yonghuIdNumber">
                       <el-input v-model="ruleForm.yonghuIdNumber"
                                 placeholder="保管人员身份证号" clearable  :readonly="ro.yonghuIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   yonghuName: [
                              { required: true, message: '保管人员姓名不能为空', trigger: 'blur' },
                          ],
                   yonghuPhoto: [
                              { required: true, message: '头像不能为空', trigger: 'blur' },
                          ],
                   yonghuPhone: [
                              {  required: true, message: '保管人员手机号不能为空', trigger: 'blur' },
                   ...
                   yonghuIdNumber: [
                              { required: true, message: '保管人员身份证号不能为空', trigger: 'blur' },
                              { pattern: /^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$/,
                                message: '保管人员身份证号格式有误！',
                                trigger: 'blur'
                              }
                          ],
                   yonghuEmail: [
