    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="借用原因" prop="newsText">
                        <el-input type="textarea"  :readonly="ro.newsText" v-model="ruleForm.newsText" placeholder="借用原因"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.newsText" label="借用原因" prop="newsText">
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   insertTime: [
                              { required: true, message: '数据添加时间不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        created() {
         ...
         this.$http({
             url: `gudingzichan/page?page=1&limit=100&gudingzichanStatusTypes=1&quan=1`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
