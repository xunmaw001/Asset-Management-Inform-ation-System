        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yonghu'">
                    <el-form-item class="select" v-if="type!='info'"  label="保管人员" prop="yonghuId">
                        <el-select v-model="ruleForm.yonghuId" :disabled="ro.yonghuId" filterable placeholder="请选择保管人员" @change="yonghuChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="保管人员姓名" prop="yonghuName">
                        <el-input v-model="yonghuForm.yonghuName"
                                  placeholder="保管人员姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="保管人员姓名" prop="yonghuName">
                            <el-input v-model="ruleForm.yonghuName"
                                      placeholder="保管人员姓名" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="保管人员手机号" prop="yonghuPhone">
                        <el-input v-model="yonghuForm.yonghuPhone"
                                  placeholder="保管人员手机号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="保管人员手机号" prop="yonghuPhone">
                            <el-input v-model="ruleForm.yonghuPhone"
                                      placeholder="保管人员手机号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="保管人员身份证号" prop="yonghuIdNumber">
                        <el-input v-model="yonghuForm.yonghuIdNumber"
                                  placeholder="保管人员身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="保管人员身份证号" prop="yonghuIdNumber">
                            <el-input v-model="ruleForm.yonghuIdNumber"
                                      placeholder="保管人员身份证号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="资产编号" prop="gudingzichanUuidNumber">
                       <el-input v-model="ruleForm.gudingzichanUuidNumber"
                                 placeholder="资产编号" clearable  :readonly="ro.gudingzichanUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="资产名称" prop="gudingzichanName">
                       <el-input v-model="ruleForm.gudingzichanName"
                                 placeholder="资产名称" clearable  :readonly="ro.gudingzichanName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="资产类型" prop="gudingzichanTypes">
                        <el-select v-model="ruleForm.gudingzichanTypes" :disabled="ro.gudingzichanTypes" placeholder="请选择资产类型">
                            <el-option
                                v-for="(item,index) in gudingzichanTypesOptions"
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="使用部门" prop="bumenTypes">
                        <el-select v-model="ruleForm.bumenTypes" :disabled="ro.bumenTypes" placeholder="请选择使用部门">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="存放地点" prop="addressTypes">
                        <el-select v-model="ruleForm.addressTypes" :disabled="ro.addressTypes" placeholder="请选择存放地点">
                            <el-option
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="增加方式" prop="addTypes">
                        <el-select v-model="ruleForm.addTypes" :disabled="ro.addTypes" placeholder="请选择增加方式">
                            <el-option
                                v-for="(item,index) in addTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="资产状态" prop="gudingzichanStatusTypes">
                        <el-select v-model="ruleForm.gudingzichanStatusTypes" :disabled="ro.gudingzichanStatusTypes" placeholder="请选择资产状态">
                            <el-option
                                v-for="(item,index) in gudingzichanStatusTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gudingzichanPhoto" label="资产图片" prop="gudingzichanPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.gudingzichanPhoto?ruleForm.gudingzichanPhoto:''"
                            @change="gudingzichanPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="单位" prop="gudingzichanDanwei">
                       <el-input v-model="ruleForm.gudingzichanDanwei"
                                 placeholder="单位" clearable  :readonly="ro.gudingzichanDanwei"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="制造厂家" prop="gudingzichanZhizaochangjia">
                       <el-input v-model="ruleForm.gudingzichanZhizaochangjia"
                                 placeholder="制造厂家" clearable  :readonly="ro.gudingzichanZhizaochangjia"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="原价" prop="gudingzichanYuanjia">
                       <el-input v-model="ruleForm.gudingzichanYuanjia"
                                 placeholder="原价" clearable  :readonly="ro.gudingzichanYuanjia"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="gudingzichanXianjia">
                       <el-input v-model="ruleForm.gudingzichanXianjia"
                                 placeholder="现价" clearable  :readonly="ro.gudingzichanXianjia"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="出厂日期" prop="gudingzichanTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.gudingzichanTime"
                                type="datetime"
                                placeholder="出厂日期"
                                :disabled="ro.gudingzichanTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gudingzichanTime" label="出厂日期" prop="gudingzichanTime">
                            <span v-html="ruleForm.gudingzichanTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="资产描述" prop="gudingzichanContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.gudingzichanContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gudingzichanContent" label="资产描述" prop="gudingzichanContent">
                            <span v-html="ruleForm.gudingzichanContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    gudingzichanUuidNumber: false,
                    gudingzichanName: false,
                    gudingzichanTypes: false,
                    bumenTypes: false,
                    addressTypes: false,
                    addTypes: false,
                    yonghuId: false,
                    gudingzichanStatusTypes: false,
                    gudingzichanPhoto: false,
                    gudingzichanDanwei: false,
                    gudingzichanZhizaochangjia: false,
                    gudingzichanYuanjia: false,
                    gudingzichanXianjia: false,
                    gudingzichanTime: false,
                    gudingzichanContent: false,
                },
                ruleForm: {
                    gudingzichanUuidNumber: new Date().getTime(),
                    gudingzichanName: '',
                    gudingzichanTypes: '',
                    bumenTypes: '',
                    addressTypes: '',
                    addTypes: '',
                    yonghuId: '',
                    gudingzichanStatusTypes: '',
                    gudingzichanPhoto: '',
                    gudingzichanDanwei: '',
                    gudingzichanZhizaochangjia: '',
                    gudingzichanYuanjia: '',
                    gudingzichanXianjia: '',
                    gudingzichanTime: '',
                    gudingzichanContent: '',
                },
                gudingzichanTypesOptions : [],
                bumenTypesOptions : [],
                addressTypesOptions : [],
                addTypesOptions : [],
                gudingzichanStatusTypesOptions : [],
                yonghuOptions : [],
                rules: {
                   gudingzichanUuidNumber: [
                   ...
                   addTypes: [
                              { required: true, message: '增加方式不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gudingzichan_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gudingzichanTypesOptions = data.data.list;
                    }
                });
                this.$http({
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=add_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.addTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=gudingzichan_status_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.gudingzichanStatusTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            //图片
            gudingzichanPhotoUploadChange(fileUrls){
                this.ruleForm.gudingzichanPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
