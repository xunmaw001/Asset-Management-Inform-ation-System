    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="gudingzichanId" name="gudingzichanId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="折旧价格" prop="zichanzhejiu">
                       <el-input v-model="ruleForm.zichanzhejiu"
                                 placeholder="折旧价格" clearable  :readonly="ro.zichanzhejiu"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="折旧价格" prop="zichanzhejiu">
                           <el-input v-model="ruleForm.zichanzhejiu"
                                     placeholder="折旧价格" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   zichanzhejiu: [
                              { required: true, message: '折旧价格不能为空', trigger: 'blur' },
        ...
        created() {
         ...
         this.$http({
             url: `gudingzichan/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
